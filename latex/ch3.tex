...
\begin{table}[H]
	\begin{tabular}{|l|}
		...
		\textbf{ID }: 12 \\ \hline
		\textbf{Description brève :}L'administrateur Créer un circuit de Workflow pour \\l'enchainement des dossiers \\ \hline
...
\begin{table}[H]
	\begin{tabular}{|l|}
		...
		\begin{tabular}[c]{@{}l@{}}\textbf{Enchainement principal :}
			\\ -L'administrateur sélectionner le dossier ou la  tâche et en appuyant\\ sur rechercher .  
			\\ -Le système  afficher l'état des dossiers   \end{tabular} \\ \hline
 ...
 \begin{table}[H]
 	...
 	\textbf{Pré-conditions :} L’utilisateur doit être  connecté au  système. \\ \hline
 		\begin{tabular}[c]{@{}l@{}}\textbf{Enchainement principal :} Ce cas d’utilisation commence lorsqu’un utilisateur\\ souhaite accéder à l’application.
 			...
 			\\ 2. système répond à l’utilisateur en afficher un formulaire d'enregistrement.
 			\\ 3. L’utilisateur saisit le code et le non-prénom est numéro téléphone de \\ propriétaire de dossier.
...
\begin{table}[H]
	\begin{tabular}{|l|}
		...
		\begin{tabular}[c]{@{}l@{}}\textbf{Enchainement principal :} \\ 1.   L’utilisateur sélectionne   la liste des dossiers. \\2.      système répond à l’utilisateur en afficher  les listes des dossiers \\ \{"tous la liste","liste activée ","liste non activée"\}. \\3.       L’utilisateur sélectionné  dossier \\ 4. le système  répond à l’utilisateur en afficher le Detaille, est après\\  en appuyant sur "Activer".\\5. le système vérifie id "code" de dossier et activer leur état \end{tabular} \\ \hline
...
\\ - L’utilisateur doit être connecté ou le système.
		...
		\begin{tabular}[c]{@{}l@{}}\textbf{Enchainement principal :} \\ 1. L’utilisateur sélectionnait le statut des dossiers.
			\\ 2. système répond à l’utilisateur en afficher les listes des dossiers encore de traitement\\ au les nouveaux dossiers envoyés \end{tabular} \\ \hline
