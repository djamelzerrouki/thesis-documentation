...
\begin{table}[!h]
	...
	\begin{tabular}{|l|l|l|l|l|}
		...
		\textbf{Critères} & \textbf{\begin{tabular}[h]{@{}l@{}}De\\   production\end{tabular}} & \textbf{Administratif} & \textbf{Ad-hoc} & \textbf{Collaboratif} \\ \hline
		\textbf{\begin{tabular}[c]{@{}l@{}}Capacité \\de \\    traitement\end{tabular}} &   \begin{tabular}[c]{@{}l@{}}Haute capacité de \\   traitement Temps \\   de réponse rapide.\\Le but est la\\   Productivité\end{tabular} &   \begin{tabular}[c]{@{}l@{}}Capacité de \\traitement\\   inferieure(10 à \\100)fois moins \\que pour un  \\workflow de\\ production\end{tabular} &  \begin{tabular}[c]{@{}l@{}}Facilite \\   d'utilisation et \\   d'apprentissage \\   sont très \\   importantes.\end{tabular} &  \begin{tabular}[c]{@{}l@{}}Capacité de \\   changer \\   dynamiquement\\la définition \\   d’un processus \\   est essentielle\end{tabular} \\ \hline
		\rowcolor[HTML]{96FFFB} 
		\textbf{Utilisation} & \begin{tabular}[c]{@{}l@{}}Employés\\   travaillant à plein\\ temps sur des\\   activités  courtes.\end{tabular} & \begin{tabular}[c]{@{}l@{}}Un grand \\nombre  \\d'employés\\   peuvent \\être   impliqués\end{tabular} & \begin{tabular}[c]{@{}l@{}}La modification \\   dynamique et \\rapide\\ des  processus\\ est    essentielle.\end{tabular} & \begin{tabular}[c]{@{}l@{}}Fournir\\  une voie\\    structurée pour \\   travailler\\ ensemble\end{tabular} \\ \hline
		\textbf{\begin{tabular}[c]{@{}l@{}}Nature des \\ processus\end{tabular}} & \begin{tabular}[c]{@{}l@{}}Processus formels \\   avec peu de \\   variation Les \\   processus peuvent \\   être très \\   complexes.\end{tabular} & \begin{tabular}[c]{@{}l@{}}Une variété de \\  processus pout \\exister dans\\ même système. \\   Les processus\\ peuvent être \\bien définis, mais \\   requièrent moins \\   d'exigence.\end{tabular} & \begin{tabular}[c]{@{}l@{}} Facilité \\de  déploiement.\end{tabular}& \begin{tabular}[c]{@{}l@{}}Les processus \\   sont moins \\   rigides\end{tabular} \\ \hline
		\rowcolor[HTML]{96FFFB} 
		\textbf{Spécificités} & \begin{tabular}[c]{@{}l@{}}Requiert une\\ 
			intégration serrée \\
			avec les systèmes \\
			de bases.
		\end{tabular} & \begin{tabular}[c]{@{}l@{}} Utilise souvent \\des
			documents \\attaches.\end{tabular} & \begin{tabular}[c]{@{}l@{}}Le but est de \\zéro
			coût \\
			d’administration .
