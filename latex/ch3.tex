...
\begin{table}[H]
	\begin{tabular}{|l|}
		...
		\\ - L’utilisateur doit être connecté au système. 
		\\ \hline
		\begin{tabular}[c]{@{}l@{}}\textbf{Enchainement principal :} \\ 1. L’utilisateur sélectionne la liste des dossiers pour la transférer à \\la tâche  suivante.\\ 2.Le système répond à l’utilisateur et créer un nouveau bordereau et affiche la liste\\ de bordereau correspondant à leur tâche. 
