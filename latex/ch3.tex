...
\begin{wrapfigure}{l}{0.2\textwidth} %this figure will be at the right
	\centering                            
	\includegraphics[width=0.1\textwidth]{images/ms-img04}
\end{wrapfigure}
...
\end{itemize}
 ...
 \begin{document}
 	\begin{itemize}
 		\item[\authorimg{images/ms-img04}] Author of Firefoxjjjjjjjjjjjjj
 		...
 		\item[\authorimg{images/ms-img04}] Author of Apache Ant
 	\end{itemize}
 \end{document}