...
Pour cela, aller au site \underline{\textbf{start.spring.io}}, et créer un projet avec les caractéristiques suivantes:
...
\end{figure}
 ...
 \subsection{Captures d'écrin de l'administrateur }
  \subsubsection{Authentification}
   Cette interface est la fenêtre de bienvenue. 
 A travers cette fenêtre utilisateur, il est nécessaire d’utiliser le système. Cette étape améliore le côté sécurité et vérifie la disponibilité du compte utilisateur et la précision du mot de passe à ce niveau.
...
L'administrateur pus crée un circuit de n'apport quel dossier via un interface graphique simple et utile .

 Création d'un workflow pour un service de la \ac{cnr} comme montre la figure \ref{fig:bpmn}.  
\begin{figure}[H]
	\centering
...
\end{figure}
 ...
 Un administrateur peut gérer des tâches en modifiant des informations telles que délai de traitement de tâche par les jours et le service. Il peut également afficher le statut des fichiers dans chaque tâche.
\begin{figure}[H]
	\centering
