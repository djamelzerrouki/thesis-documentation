...
\begin{itemize}
 ...
 Nous avons utilisé le Framework CSS \textbf{Bootstrap3} qui dispose d’une grid pour faciliter la gestion de la mise en forme des pages HTML. Il offre aussi des composants de design basés sur HTML et CSS avec un\textbf{ Responsive design} qui permet un affichage qui s’adapte à la taille de l’écran, que ce soit une tablette, un smartphone ou un ordinateur.
\end{itemize}
